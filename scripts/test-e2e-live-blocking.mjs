...
const prompt = [
  ...
  'Call subagent with name "Live Blocking Child", agent "live-e2e-blocking", title "Live blocking child check", task "Follow your exact built-in instructions.", and parentClosePolicy "terminate".',
